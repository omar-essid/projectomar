        ...
        stage('Scan Docker Image with Trivy') {
            steps {
                script {
                    ...
                    sh 'trivy image --timeout 45m --scanners vuln --exit-code 1 --severity HIGH,CRITICAL --cache-dir /home/jenkins/.cache/trivy ${registry}:latest' // Fail the pipeline if high/critical vulnerabilities are found
                }
            }
        }
